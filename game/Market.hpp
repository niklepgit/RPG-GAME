...
class Market{
	...
	public:
		...
		void Sell(Hero& hero);
		void Buy(Hero&hero);
		Armor buyArmor(int position,int& Money,int LevelOfHero,int& bought);
		Weapon buyWeapon(int position,int& Money,int LevelOfHero,int& bought);
		Potion buyPotion(int position,int& Money,int LevelOfHero,int& bought);
		Spell* buySpell(int position,int& Money,int LevelOfHero,int& bought);
};
